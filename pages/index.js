...
export default function Home() {
  ...
  return (
   ...
   <div className="flex bg-yellow-400 px-10 mt-5 flex-col space-y-4 py-10 rounded-xl md:mx lg:mx-[400px]">
   <p>NFT MarketPlace</p>
   ...
   <input type="text" className="h-20" placeholder="Enter your description" value={description} onChange={(e)=>{setDescription(e.target.value)}} className="border border-black px-2 " />
   <div>
